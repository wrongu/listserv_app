...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.gm_id'
        db.add_column(u'emails_message', 'gm_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0L, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.gm_id'
        db.delete_column(u'emails_message', 'gm_id')
